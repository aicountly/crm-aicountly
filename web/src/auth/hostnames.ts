 ...
 * crm.aicountly.com and crm.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'crm').trim() || 'crm'
...
/**
 * `crm.aicountly.com` and `crm.gh.aicountly.com` both resolve to
 * `crm`, which is what the portal expects in authentication_jump.
 */
