...
CRM for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://crm.aicountly.com | https://crm.aicountly.com/api |
| Sandbox | https://crm.gh.aicountly.com | https://crm.gh.aicountly.com/api |
...
(`https://crm.gh.aicountly.com/api`) so the token exchange has somewhere to
